...
public class BookDao extends AbstractDao<Book, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property StringURL = new Property(2, String.class, "StringURL", false, "STRING_URL");
    ...
    public Book readEntity(Cursor cursor, int offset) {
        Book entity = new Book( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2), // StringURL
    ...
    public void readEntity(Cursor cursor, Book entity, int offset) {
        ...
        entity.setStringURL(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
