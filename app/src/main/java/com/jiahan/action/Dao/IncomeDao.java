...
import com.jiahan.action.Bean.Income;
...
public class IncomeDao extends AbstractDao<Income, Long> {
    ...
    */
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Income entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(Income entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
